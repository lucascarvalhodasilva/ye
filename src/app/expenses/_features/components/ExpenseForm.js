          ...
          {!tempExpenseReceipt ? (
            <div className="grid grid-cols-2 gap-3">
              <button 
                ...
                className="p-3 rounded-xl dark:bg-white/5 border-2 border-dashed border-rose-500/50 bg-rose-500/5 transition-all flex flex-col items-center gap-2 group"
              >
            ...
            <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-border/50">
              ...
              <div className="absolute top-2 right-2 flex items-center gap-1.5">
                <button 
                  type="button" 
                  onClick={() => takeExpensePicture(CameraSource.Camera)}
                  className="w-8 h-8 rounded-lg bg-white/90 dark:bg-black/70 backdrop-blur-sm shadow-lg flex items-center justify-center text-muted-foreground hover:text-rose-600 hover:bg-white dark:hover:bg-black/90 transition-all active:scale-95"
                  title="Neu aufnehmen"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <button 
                  ...
                  className="w-8 h-8 rounded-lg bg-white/90 dark:bg-black/70 backdrop-blur-sm shadow-lg flex items-center justify-center text-muted-foreground hover:text-red-500 hover:bg-white dark:hover:bg-black/90 transition-all active:scale-95"
                  title="Entfernen"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
